...
function materialize(catalog, extra, override, discovered) {
  ...
  if (reasoningMode === 'off') {
    ...
    const offered = vendorWire(catalog)
    if (offered?.reasoning) {
      reasoning = offered.reasoning
      compat = offered.compat
      reasoningSource = 'catalog-offered'
    }
  }
  ...
  return {
    ...
    catalogReasoningLevels: Object.keys(catalog?.optionalReasoning || catalog?.reasoning || {}),
    compat,
    reasoningSource,
